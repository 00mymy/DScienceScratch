...
for user in users:
    #user["degree_centrality"] = number_of_friends(user) / total_connections
    user["degree_centrality"] = number_of_friends(user) / avg_connections
...
if __name__ == "__main__":
    ...
    for user in users:
        print(user["id"], user["degree_centrality"])
    print()
    ...
    for user_id, centrality in enumerate(matrix_operate(adjacency_matrix, eigenvector_centralities)):
