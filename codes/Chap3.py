...
movies = ["Annie Hall", "Ben-Hur", "Casablanca", "Gandhi Gandhi", "West Side Story"]
...
plt.xticks([i for i, _ in enumerate(movies)], movies, rotation=45)
...
#앞에서 배운거 응용 - 간단하게 테스트해 보기

plt.bar([.1, 1.1], mentions, .8)
#plt.axis([0, 2,400,550])
plt.xticks([.1, 1.1], years)
plt.title("Not So Huge Anymore")
plt.show()
