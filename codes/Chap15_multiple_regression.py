...
from Chap14_simple_linear_regression import total_sum_of_squares
import math, random
...
if __name__ == "__main__":
    ...
    print("p_value(", beta[0], ",", bootstrap_standard_errors[0], ") : ", p_value(beta[0], bootstrap_standard_errors[0]), sep='')
    print("p_value(", beta[1], ",", bootstrap_standard_errors[1], ") : ", p_value(beta[1], bootstrap_standard_errors[1]), sep='')
    print("p_value(", beta[2], ",", bootstrap_standard_errors[2], ") : ", p_value(beta[2],bootstrap_standard_errors[2]), sep='')
    print("p_value(", beta[3], ",", bootstrap_standard_errors[3], ") : ", p_value(beta[3],bootstrap_standard_errors[3]), sep='')
    print()
    '''
