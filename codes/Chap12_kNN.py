...
# Example - Favorite Programming Languages by region
...
def plot_state_borders(plt, color='0.8'):
    psb.plot_state_borders(plt, color)
...
for k in [1, 3, 5, 7]:
    ...
    for city in cities:
        ...
        if predicted_language == actual_language:
            num_correct += 1
    print(k, "neighbor[s]: %d/%d (%f)" % (num_correct, len(cities), num_correct/len(cities) ))
'''
